...
import CodeTitle from "~/components/CodeTitle.astro";
...
<CodeTitle name="src/routes/index.tsx" />
...
{/* <CodeTitle name="src/app/home/components/SimpleForm.tsx" /> */}
...
<CodeTitle name="src/lib/submitFormData.ts" />
