...
ogFilename: pages/sitemap.xml.js
...
In your Next.js project, create a new file named `sitemap.xml.js` in the `pages` directory.
...
```javascript utils/getTotalCounts.js
...
```javascript utils/getSitemapPages.js
...
```javascript pages/sitemap/[slug].js
...
```javascript utils/getSitemapPageUrls.js
import axios from "axios";
...
```javascript utils/generateSitemapPaths.js
